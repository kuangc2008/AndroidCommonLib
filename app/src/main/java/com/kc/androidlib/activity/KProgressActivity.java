...
public class KProgressActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        switch (v.getId()) {
            ...
            case R.id.custom_img_test:
                new KAlertDialog(this, KAlertDialog.CUSTOM_IMAGE_TYPE)
                        ...
                        .setCustomImage(R.mipmap.ic_launcher,KProgressActivity.this)
                        .setConfirmText("OK")
                        .show();
                break;
                        ...
                        switch (i) {
                            case 0:
                                pDialog.getProgressHelper().setBarColor(ContextCompat.getColor
                                        (KProgressActivity.this,R.color.blue_btn_bg_color));
                                break;
                            case 1:
                                pDialog.getProgressHelper().setBarColor(ContextCompat.getColor
                                        (KProgressActivity.this,R.color.material_deep_teal_50));
                                break;
                            case 2:
                            case 6:
                                pDialog.getProgressHelper().setBarColor(ContextCompat.getColor
                                        (KProgressActivity.this,R.color.success_stroke_color));
                                break;
                            case 3:
                                pDialog.getProgressHelper().setBarColor(ContextCompat.getColor
                                        (KProgressActivity.this,R.color.material_deep_teal_20));
                                break;
                            case 4:
                                pDialog.getProgressHelper().setBarColor(ContextCompat.getColor
                                        (KProgressActivity.this,R.color.material_blue_grey_80));
                                break;
                            case 5:
                                pDialog.getProgressHelper().setBarColor(ContextCompat.getColor
                                        (KProgressActivity.this,R.color.warning_stroke_color));
                                break;
                        }
                    }
